        ...
        <div class="col-10 col-md-5 col-xl-3">
          <div class="card text-bg-dark">
            ...
            <form class="card-body">
              ...
              <!-- / Button 'Sign Up' / -->
              <button type="button" class="my-btn-black btn btn-outline-light w-100" @click="signUp(user)">
                Sign Up
              </button>
              <!-- / Error message / -->
              <div class="row text-center fs-5 text-danger mt-3">
                <span>{{ store.state.authorizeMessage }}</span>
              </div>
            </form>
          </div>
        </div>
